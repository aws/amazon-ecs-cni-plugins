...
integration-test: $(SOURCE)
	go test -v -tags integration -race -gcflags=all=-d=checkptr=0 -timeout 10s ./pkg/... ./plugins/...

sudo-integration-test: $(SOURCE)
	sudo -E ${GO_EXECUTABLE} test -v -tags "sudo integration" -race -gcflags=all=-d=checkptr=0 -timeout 10s ./plugins/...
